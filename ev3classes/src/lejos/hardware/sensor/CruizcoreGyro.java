...
public class CruizcoreGyro extends I2CSensor {
   ...
   * The sample contains 3 elements. Each element gives linear acceleration (in
   * metres/second^2). Axis order in sample is X, Y, Z.
   * 
   * <p>
   * <b>Configuration</b><br>
   * The sensor can be configured for range using the setAccScale#G() methods of
   * the sensor class.
   * 
   ...
   * <p>
   * <b>Configuration</b><br>
   * The accumulated angle can be reset to zero using the reset() method of the
   * sensor class.
   * 
   * @return A sampleProvider
   * @see {@link lejos.robotics.SampleProvider leJOS conventions for
