 ...
 * The status of the sensor can be checked using the {@link linkStatus()}
 * method.
 * 
 * <p>
 * 
 * @see <a href="http://www.dexterindustries.com/manual/dgps-2/"> Sensor
 *      datasheet </a>
 * @see <a href="http://www.dexterindustries.com/dGPS.html"> Sensor Product page
 *      </a>
...
public class DexterGPSSensor extends I2CSensor {
  ...
  public static final byte DGPS_I2C_ADDR   = 0x06;       /*
                                                           * !< Barometric
                                                           * sensor device
                                                           * address
                                                           */
  public static final byte DGPS_CMD_UTC    = 0x00;       /* !< Fetch UTC */
  public static final byte DGPS_CMD_STATUS = 0x01;       /*
                                                           * !< Status of
                                                           * satellite link: 0
                                                           * no link, 1 link
                                                           */
  ...
  public static final byte DGPS_CMD_VELO   = 0x06;       /*
                                                           * !< Fetch velocity
                                                           * in cm/s
                                                           */
  public static final byte DGPS_CMD_HEAD   = 0x07;       /*
                                                           * !< Fetch heading in
                                                           * degrees
                                                           */
  public static final byte DGPS_CMD_DIST   = 0x08;       /*
                                                           * !< Fetch distance
                                                           * to destination
                                                           */
  public static final byte DGPS_CMD_ANGD   = 0x09;       /*
                                                           * !< Fetch angle to
                                                           * destination
                                                           */
  public static final byte DGPS_CMD_ANGR   = 0x0A;       /*
                                                           * !< Fetch angle
                                                           * travelled since
                                                           * last request
                                                           */
  public static final byte DGPS_CMD_SLAT   = 0x0B;       /*
                                                           * !< Set latitude of
                                                           * destination
                                                           */
  public static final byte DGPS_CMD_SLONG  = 0x0C;       /*
                                                           * !< Set longitude of
                                                           * destination
                                                           */
  ...
  /**
   * Return status of link to the GPS satellites LED on dGPS should light if
   ...
   * The sample contains 2 elements. The first element is latitude, the second
   * longitude. <br>
   * The sensor uses an integer-based representation of latitude and longitude
   * values. Assume that you want to convert the value of 77 degrees, 2 minutes
   * and 54.79 seconds to the integer-based representation. The integer value is
   * computed as follows: <code>R = 1000000 * (D + M / 60 + S / 3600)</code>
   * where <code>D=77</code>, <code>M=2</code>, and <code>S=54.79</code>. For
   * the given values, the formula yields the integer value 77048553. Basically,
   * this is equivalent to decimal degrees times a million.
   * 
   * 
   ...
   * <p>
   * <b>Size and content of the sample</b><br>
   * The sample contains one element representing the heading (in degrees) of
   * the sensor. Accurate heading information can only be given when the sensor
   * is in motion.
   * 
   * @return A sampleProvider
   * @see {@link lejos.robotics.SampleProvider leJOS conventions for
   ...
   * <p>
   * <b>Size and content of the sample</b><br>
   * The sample contains one elements giving the speed of the sensor (in
   * metres/second).
   * 
   * 
   * @return A sampleProvider
