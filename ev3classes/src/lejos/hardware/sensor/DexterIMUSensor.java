 ...
 * <tr>
 * <td>Temperature</td>
 * <td>The Temperature mode measures the internal temperature of the sensors
 * gyroscope IC</td>
 ...
 * The sensor cannot be configured directly. The internal update frequency of
 * the sensor is adjusted automaticly to match the I2C port speed.
 * 
 * <p>
 * 
 * @see <a href="http://dexterindustries.com/files/dIMU_Datasheets.zip"> Sensor
 *      datasheet </a>
 * @see <a href="http://www.dexterindustries.com/dIMU.html"> Sensor Product page
 *      </a>
...
public class DexterIMUSensor extends BaseSensor implements SensorModes {
   ...
   * The sample contains three elements. Each element gives the linear
   * acceleration (in metres/second^2) of the sensor over a single axis. The
   * order of the axes in the sample is X, Y and Z.
   * 
   * <p>
   * <b>Configuration</b><br>
   * The sensor is configured for a dynamic range of -2G tot 2G and an internal
   * update rate of 125 Hertz. Currently there are no configurable settings.
   * 
   * @return A sampleProvider
   * @see {@link lejos.robotics.SampleProvider leJOS conventions for
   *      SampleProviders}
   * @see <a
   *      href="http://www.freescale.com/files/sensors/doc/data_sheet/MMA7455L.pdf">
   *      Freescale MMA7455L datasheet </a>
   */
   ...
   * <p>
   * <b>Size and content of the sample</b><br>
   * The sample contains three elements. Each element gives the angular speed
   * (in degrees/second) of the sensor over a single axis. The order of the axes
   * in the sample is X, Y and Z.
   * 
   * <p>
   * <b>Configuration</b><br>
   * The sensor is configured for a dynamic range from -2000 to 2000
   * degrees/second. The internal sample rate is 100 Hertz by default and 400
   * Hertz when the sensor port is configured for high speed. Currently there
   * are no configurable settings.
   * 
   * @return A sampleProvider
   * @see {@link lejos.robotics.SampleProvider leJOS conventions for
   *      SampleProviders}
   * @see <a
   *      href="http://www.st.com/st-web-ui/static/active/en/resource/technical/document/datasheet/CD00265057.pdf">ST
   *      L3G4200D datasheet </a>
   */
   ...
   * The Temperature mode measures the internal temperature of the sensors
   * gyroscope IC
   * 
   * <p>
   * <b>Size and content of the sample</b><br>
   * The sample contains one elements providing the internal temperature (in
   * gegrees Celcius) of the gyro sensors. Please note that the internal
   * temperature of the sensor will exceed the temperature of the environment
   * when the sensor is in use.
   * 
   * <p>
   * <b>Configuration</b><br>
   * The temperature range of the sensor is -40 to 85 degrees Celcius. The
   * update rate is 1 Hertz. There are no configurable settings.
   * 
   * @return A sampleProvider
   * @see {@link lejos.robotics.SampleProvider leJOS conventions for
   *      SampleProviders}
  ...
  private class DexterIMUGyroSensor extends I2CSensor {
    ...
    /**
     * Provides access to the temperature data on the Gyro sensor Method added
     * for consistency with other SensoModes
     * 
     * @return
     */
    @SuppressWarnings("unused")
