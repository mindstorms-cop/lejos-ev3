  ...
  begin
    ...
    begin
      ...
      Caption := 'You have selected to install the leJOS Development Kit Sources. '
        + 'They are not required for developing Java programs that run the EV3 or '
        + 'Java programs that remote-control the EV3. Instead, they are intended '
    ...
    begin
      ...
      Values[0] := ExpandConstant('{userdocs}\LeJOS EV3 Samples');
      Values[1] := ExpandConstant('{userdocs}\LeJOS EV3 Development Kit Sources');
